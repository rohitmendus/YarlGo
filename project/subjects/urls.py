...
urlpatterns = [
    ...
    path('delete_subject/<int:subject_id>/', views.AdminSubjectsView.as_view(), name="delete_subject"),
    path('edit_subject/<int:subject_id>/', views.AdminSubjectsView.as_view(), name='edit_subject'),
]
